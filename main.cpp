// Программа "Hello, World!" на C++ — Суперподробное объяснение
// В этой программе мы выведем на экран сообщение "Hello, World!", но углубимся в то,
// как работает весь процесс от начала (препроцессинг) до конца (вывод символов на экран).
